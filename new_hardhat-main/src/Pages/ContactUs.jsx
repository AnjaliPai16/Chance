          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="mb-4 block text-base font-semibold text-primary text-slate-100">
                  Contact Us
                </span>
                <h2 className="mb-6 text-[32px] font-bold uppercase text-dark text-slate-400 sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-dark text-slate-300">
                      Our Location
                    </h4>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-slate-900 p-8 shadow-lg dark:bg-dark-11 sm:p-12">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border-slate-600 border border-primary bg-primary p-3 text-slate-300 transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
