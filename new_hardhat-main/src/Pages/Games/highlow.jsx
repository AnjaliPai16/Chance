            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button 
                  ...
                  disabled={!canGuess} 
                  className={`bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 ${!canGuess && "opacity-50 cursor-not-allowed"}`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <button 
                  ...
                  disabled={!canGuess} 
                  className={`bg-red-600 hover:bg-red-700 text-white font-medium py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 ${!canGuess && "opacity-50 cursor-not-allowed"}`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <button 
                onClick={cashOut} 
                disabled={streak === 0} 
                className={`w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-medium py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 ${streak === 0 && "opacity-50 cursor-not-allowed"}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="mt-8 bg-[#131922] rounded-xl p-4 border border-[#2a3449]">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#1a2234] p-3 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-yellow-400"> {score.toFixed(2)}</p>
                </div>
                <div className="bg-[#1a2234] p-3 rounded-lg">
